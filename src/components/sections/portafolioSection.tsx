        ...
        <div className="bg-shape top-shape" />
            <div className="about-container">
                <div className="about-text">
                    ...
                    <p style={{fontStyle:"italic"}}><strong>{t[locale].portafolioSection.project1}</strong></p>
                    ...
                    <p style={{fontStyle:"italic"}}><strong>{t[locale].portafolioSection.project2}</strong></p>
                    ...
                    <p style={{fontStyle:"italic"}}><strong>{t[locale].portafolioSection.project3}</strong></p>
                    ...
                    <p style={{fontStyle:"italic"}}><strong>{t[locale].portafolioSection.project4}</strong></p>
